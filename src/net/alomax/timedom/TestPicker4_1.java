...
// _DOC_ TestPicker4_1
// _DOC_ =============================
public class TestPicker4_1 extends BasicPicker {
    ...
    private TestPicker4_1_Memory mem = null;
    ...
    /** constructor */
    public TestPicker4_1(String localeText, double longTermWindow, double threshold1, double threshold2,
    ...
    /** copy constructor */
    public TestPicker4_1(TestPicker4_1 tp) {
    ...
    public final float[] apply(double dt, float[] sample) {
        ...
        if (mem == null) {
            mem = new TestPicker4_1_Memory(sample);
        }
        ...
        for (int n = 0; n < sample.length; n++) {
            ...
            for (int k = mem.numRecursive - 1; k >= 0; k--) {
                // AJL 20090519 20090520
                //mem.filteredSample[k][mem.numPreviousPtr] = mem.filteredSample[k][mem.numPreviousPtrLast] * mem.decayConst[k] + currentSample * mem.decayFactor[k];
                currentFilteredSample = mem.filteredSample[k][mem.numPreviousPtrLast] * mem.decayConst[k] + currentDiffSample * mem.decayFactor[k];
                // AJL 20090521
                ...
                // AJL 20090521double dy = currentFilteredSample;
                mem.filteredSample[k][mem.numPreviousPtr] = currentFilteredSample;
                ...
                if (mem.mean_stdDev_xRec[k] <= Float.MIN_VALUE) {
                    if (mem.enableTriggering && error1_not_printed) {
                        System.out.println("ERROR: TestPicker4_1: mem.mean_stdDev_xRec[k] <= Float.MIN_VALUE (this should not happen!) k=" + k);
            ...
            //AJL20090512 boolean doResetCharFunctUncertainty =
    ...
    /** custom memory class */
    // _DOC_ =============================
    // _DOC_ TestPicker4_1_Memory object/structure
    // _DOC_ =============================
    public class TestPicker4_1_Memory extends TimeDomainMemory {
...

        {
            for (int k = 0; k < numRecursive; k++) {
                ...
                indexDelay[k] = nDelay; // AJL 20090520
                //System.out.println("TP DEBUG k, decayFactor[k], indexDelay[k], window[k] " + k + " " + decayFactor[k] + " " + indexDelay[k] + " " + window);
                window *= 2.0;
                nDelay *= 2;
            }
        }
        ...
        double uncertaintyAtResetCharFunctUncertainty = Double.MAX_VALUE;   // AJL20090520
        //AJL20090512
        ...
        public TestPicker4_1_Memory(float[] sample) {
            ...
            for (int k = 0; k < numRecursive; k++) {
                for (int j = 0; j < numPrevious; j++) {
                    filteredSample[k][j] = 0.0;  // AJL 20091012
                    //filteredSample[k][j] = sample_mean;  // AJL 20090528 20091012
                }
            }
